/*
  ...
  Run over MC monopole tree and generate efficiency distribution as a function of beta.
  Creates comparison plot between two MC trees efficiencies. 
